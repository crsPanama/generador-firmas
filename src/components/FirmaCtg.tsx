...
export const FirmaCtg = ({ cargo, nombre, telefono1, telefono2 }: Props) => {
  return (
    <>
      <div className='flex h-[145px] gap-x-12'>
        <div className='flex justify-between bg-[#393c40] relative w-[200px]'>
          <figure className='self-center w-44 mx-auto'>
            <img
              src={`https://admin.intermarketing.com.pa/assets/ebb894e0-cf8b-483e-ab9a-03fdcbf82f82`}
              alt='Cars To Go logo'
              className='w-full mx-auto'
            />
          </figure>
          <div className='w-8 bg-[#393c40] absolute -right-4 h-full -skew-x-12'></div>
        </div>
        ...
        <div className='pt-2 flex flex-col justify-center'>
          <div>
            ...
            <div className='flex gap-x-1'>
              ...
              {telefono2 ? (
                <p className='italic text-sm flex items-center gap-x-1'>
                  |
                  <svg
