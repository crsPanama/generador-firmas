...
export const FirmaHertz = ({ cargo, nombre, telefono1, telefono2 }: Props) => {
  return (
    <>
      <div className='flex h-[125px] gap-x-10  '>
        <div className='flex justify-between  w-1/3'>
          <figure className=' self-center  w-40 mx-auto'>
            <img src={hertz} alt='hertz logo' className=' w-full mx-auto ' />
          </figure>
          <div className='w-1 bg-[#FCCC00] -skew-x-12 '></div>
        </div>
